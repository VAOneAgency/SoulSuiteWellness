<?php
/**
 * Template Name: Individual Intake Form
 * 
 * Displays the external intake form via iframe
 * 
 * @package SoulSuite
 */
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="external-form-container" style="max-width: 700px; margin: 0 auto; background: #fff; padding: 20px; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                        <iframe 
                            src="https://app.soulsuitewellness.com/forms/wtl/567b2a90319b4f9c8d06f1f6622d03e8" 
                            width="100%" 
                            height="850" 
                            frameborder="0" 
